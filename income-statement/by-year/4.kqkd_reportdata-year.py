...
# Bắt đầu từ đây
wb_code = openpyxl.load_workbook('KQKD.xlsx')
...
report = requests.post(url='https://finance.vietstock.vn/data/GetReportDataDetailValue_KQKD_ByReportDataIds', headers={'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36'}, data=data_cookie).json()['data']
c = 1
lencheck = len(report)
list_index = []
for item in report:
